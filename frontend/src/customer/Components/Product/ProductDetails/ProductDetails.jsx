...
export default function ProductDetails() {
  ...
  const productData = customersProduct.product || product;
  const productImages = customersProduct.product?.imageUrl
    ? [
        {
          src: customersProduct.product.imageUrl,
          alt: customersProduct.product.title || customersProduct.product.brand,
        },
      ]
    : product.images;
  const productSizes = customersProduct.product?.sizes || product.sizes;
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          ...
          >
            {(productData.breadcrumbs || product.breadcrumbs).map((breadcrumb) => (
            ...
            <li className="text-sm">
              <a
                href={productData.href || product.href}
                aria-current="page"
        ...
        <section className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-2 px-4 pt-10">
          ...
          <div className="flex flex-col items-center ">
            <div className=" overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
              <img
                src={activeImage?.src || customersProduct.product?.imageUrl || productImages[0]?.src}
                alt={productImages[0]?.alt || "product image"}
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">
                    {productData.details || product.details}
                  </p>
                </div>
              </div>
            </div>
              ...
              <Grid item xs={7}>
                <div className="space-y-5">
                  { review.reviews?.map((item, i) => (
                    <ProductReviewCard key={item._id || i} item={item} />
                  ))}
                </div>
              </Grid>
        ...
        <section className=" pt-10">
          ...
          <div className="flex flex-wrap space-y-5">
            {gounsPage1.map((item, index) => (
              <HomeProductCard key={item.title || index} product={item} />
            ))}
          </div>
        </section>
      </div>
