...
import StyleAssistant from "../customer/Components/AI/StyleAssistant";
...
const CustomerRoutes = () => {
    ...
    // Only show Navigation component when not on the NotFound page, login, or signup
  ...
  return (
    ...
    {showNavigation && <Navigation />}
     ...
     <Route path="/register" element={<SignupPage />}></Route>
        ...
        <Route path="/style-assistant" element={<StyleAssistant />}></Route>
