...
import AnalyticsDashboard from "./componets/Analytics/AnalyticsDashboard";
import UserManagement from "./componets/Users/UserManagement";
...
export default function AdminPannel() {
  ...
  const getMenuIcon = (index, name) => {
    if (name === "Analytics") return <AnalyticsIcon />;
    if (name === "Users") return <PeopleIcon />;
    return index % 2 === 0 ? <InboxIcon /> : <MailIcon />;
  };
